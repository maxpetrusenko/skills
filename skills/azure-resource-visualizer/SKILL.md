...
description: "Use for Analyze Azure resource groups and generate detailed Mermaid architecture diagrams showing the relationships between individual resources. Triggers: create architecture diagram, visualize Azure resources, show resource"
---
