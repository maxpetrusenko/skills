...
description: "Use for Debug and troubleshoot production issues on Azure. Triggers: debug production issues, troubleshoot container apps, analyze logs with KQL, fix image pull failures, resolve cold start issues, investigate health probe failures, check"
---
