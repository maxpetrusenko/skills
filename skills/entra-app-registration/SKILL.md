...
description: "Use for Guides Microsoft Entra ID app registration, OAuth 2.0 authentication, and MSAL integration. Triggers: create app registration, register Azure AD app, configure OAuth, set up authentication, add API permissions, generate service"
---
