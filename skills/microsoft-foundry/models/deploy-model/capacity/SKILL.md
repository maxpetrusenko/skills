---
name: capacity
description: "Use for Discovers available Azure OpenAI model capacity across regions and projects. Triggers: find capacity, check quota, where can I deploy, capacity discovery, best region for capacity, multi-project capacity search, quota analysis"
---
