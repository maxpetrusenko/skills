---
name: deploy-model
description: "Use for Unified Azure OpenAI model deployment skill with intelligent intent-based routing. Triggers: deploy model, deploy gpt, create deployment, model deployment, deploy openai model, set up model, provision model, find capacity, check"
---
