---
name: azure-prepare
description: "Use for Azure application development. Triggers: create an app, build a web app, create API, create frontend, create backend, add a feature, build a service, develop a project, migrate my app, modernize my code"
---
