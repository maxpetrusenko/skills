...
description: "Use for Troubleshoot and resolve issues with Azure Messaging SDKs for Event Hubs and Service Bus. Triggers: event hub SDK error, service bus SDK issue, messaging connection failure, AMQP error, event processor host issue, message lock"
---
