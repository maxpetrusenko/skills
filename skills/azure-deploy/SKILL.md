---
name: azure-deploy
description: "Use for Execute deployment to Azure. Triggers: run azd up, run azd deploy, execute deployment, provision infrastructure, push to production, go live, ship it, deploy web app, deploy container app, deploy static site"
---
