---
name: azure-kusto
description: "Use for Query and analyze data in Azure Data Explorer (Kusto/ADX) using KQL for log analytics, telemetry, and time series analysis. Triggers: KQL queries, Kusto database queries, Azure Data Explorer, ADX clusters, log analytics, time"
---
